...
class DonationGuidelinesScreen extends StatelessWidget {
  ...
  void _downloadGuidelines() async {
    const url =
        'https://food.ec.europa.eu/document/download/1ddc7c28-994c-4a90-ac9c-8e84cea42ef6_en?filename=fw_lib_gfd_hun_guide_food-proc-retail-sect_eng.pdf';
