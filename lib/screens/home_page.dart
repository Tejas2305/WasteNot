...
class Home Page extends StatelessWidget {
  const GradientBlankPage({super.key});
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0x3D3674B5), // 24% opacity blue (0x3D = 61 in hex = 24% opacity)
              Color(0xFFA1E3F9), // 100% opacity
            ],
            stops: [0.0, 1.0],
          ),
        ),
